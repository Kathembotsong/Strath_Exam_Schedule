            ...
            <div class="wrapper">    
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h1 style="text-align: center; background-color:rgba(205,102,105)">Number of SLS Students Taking Exam on Specific Dates</h1>
                            </div>
                            <div class="card">
                ...
                <div class="raw">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h1 style="text-align: center; background-color:rgba(5,102,205,.2)">Number of SLS Students in Each Venue at Specific Exam Time</h1>
                            </div>
                            <div class="card">
                                <div class="table-responsive">
...
<script>
    ...
    $sql = "SELECT exam_date, COUNT(DISTINCT student_code) AS num_students FROM merged_data WHERE timeslot_group_name LIKE '%SLS%' GROUP BY exam_date ORDER BY exam_date";
    $stmt = $conn->query($sql);
    ...
    $sqlVenueTime = "SELECT exam_date, exam_time, venue_name, COUNT(DISTINCT student_code) AS num_students FROM merged_data WHERE timeslot_group_name LIKE '%SLS%' GROUP BY exam_date, exam_time, venue_name ORDER BY exam_date, exam_time";
    ...
    var venueChart = new Chart(ctxVenueTime, {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Number of SLS Students in Each Venue for Each Exam Time'
            }
        }
    });
</script>
