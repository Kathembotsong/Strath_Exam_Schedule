...
try {
    ...
    $deleteQuery = "DELETE FROM exams_collision WHERE timeslot_group_name like '%BCOM%'";
                ...
                <div class="panel panel-default">
                    <center>
                        <div class="panel-heading">
                            <h1 style="text-align: center;">IDENTIFY PERSISTING CONFLICTS IN BCOM</h1>
                        </div>
                        <div class="panel-body">
                            ...
                            <form method="post">
                                ...
                                ?>
                                <a href="read_conflicts_bcom.php" style="text-decoration:none;"><span class="btn btn-primary">Identify</span></a>
