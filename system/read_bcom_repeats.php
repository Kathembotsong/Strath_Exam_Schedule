...
if(isset($_REQUEST['delete_id'])){
    ...
    $delete_stmt->execute();
    header("Location:read_bcom_repeats.php");
}

$enrol_status = "Special";
$select_stmt = $conn->prepare("SELECT * FROM enrollments_bcom WHERE enrol_status = :enrol_status");
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h1 style="text-align: center;">SPECIAL AND REPEAT EXAMS IN BCOM</h1>
                            <h3><a href="enrollment_bcom.php" style="text-decoration:none;"><span class="fas fa-plus"></span>&nbsp; Single Student to one group</a></h3>
                            <h3><a href="enrollment_multiple_bbt.php" style="text-decoration:none;"><span class="fas fa-plus"></span>&nbsp; Multiple Students to one group</a></h3>
                        </div>
