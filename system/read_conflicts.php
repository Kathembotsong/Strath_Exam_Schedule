...
$conflict_stmt = $conn->prepare("SELECT * FROM exams_collision order by student_code"); // Prepare a SELECT statement
$conflict_stmt->execute(); // Execute the SELECT statement

if (isset($_REQUEST['delete_id'])) {
    $id = $_REQUEST['delete_id']; // get delete_id and store it in $id variable
    ...
    // delete a record from the exams_collision table
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h1 style="text-align: center;">EXAM CONFLICTS</h1>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="conflictTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Timeslot Group Name</th>
                                                <th style="text-align: center;">Group Capacity</th>
                                                <th style="text-align: center;">Timeslot Subject Code</th>
                                                <th style="text-align: center;">Timeslot Subject Name</th>
                                                <th style="text-align: center;">Timeslot Lecturer Name</th>
                                        ...
                                        <tbody>
                                            <?php 
                                                while($row = $conflict_stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                            <tr>
