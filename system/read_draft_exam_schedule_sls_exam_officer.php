...
if(isset($_REQUEST['delete_id'])){
    ...
    $delete_stmt->execute();
    header("Location: read_timeslot_sls_exam_officer.php");
}
?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h1 style="text-align: center;">TIMESLOTS SLS</h1>
                            <h3><a href="create_timeslot_sls_exam_officer.php" style="text-decoration:none;"><span class="fas fa-plus"></span>&nbsp; New Exam</a></h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                    ...
                                    <tbody>
                                        <?php 
                                            $select_stmt = $conn->prepare("SELECT * FROM timeslot_bbt where group_name like '%SLS%' "); //sql select query
                                            $select_stmt->execute();
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit_draft_exam_schedule_sls_exam_officer.php?update_id=<?php echo $row['time_id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
