...
if(isset($_REQUEST['update_id'])) {
    try {
        ...
        $select_stmt = $conn->prepare('SELECT * FROM group_bbt WHERE group_id =:id'); // sql select query
...
if(isset($_REQUEST['btn_update'])) {
    try {
        ...
        if(empty($group_name)) {
            ...
            if(!isset($errorMsg)) {
                $update_stmt = $conn->prepare('UPDATE group_bbt SET group_name=:group_name, group_capacity=:group_capacity WHERE group_id=:id'); // sql update query
                ...
                if($update_stmt->execute()) {
                    ...
                    header("refresh:2;read_group_bbt.php"); // refresh 2 second and redirect to read_group_bbt.php page
                }
            }
        }
    } catch(PDOException $e) {
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h3><a href="read_group_bbt.php" style="text-decoration:none;">&laquo; Back to Group List</a></h3>
                        </div>
