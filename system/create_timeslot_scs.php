...
$subjectQuery = "SELECT subject_code, subject_name, group_name, lect_name FROM enrollments_scs";
...
function getGroupCapacity($conn, $group) {
    $sql = "SELECT group_capacity FROM group_scs WHERE group_name = ?";
    $stmt = $conn->prepare($sql);
    $stmt->execute([$group]);
        ...
        <?php include "scs_facadmin_sidebar.php";?>
            ...
            <main class="col-md-9 px-md-4" style="background-color: rgba(0,0,255,.2); width:30%; margin-left:30%; padding:2%;border-radius:5%">
                ...
                <form action="" method="post">
                    ...
                    <a href="read_draft_exam_schedule_scs.php" style="text-decoration:none; margin-left: 10px;" class="btn btn-danger">
