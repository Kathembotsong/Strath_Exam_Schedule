                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h3><a href="create_draft_exam_schedule_bbt.php" style="text-decoration:none;"><span class="fas fa-plus"></span>&nbsp; New Exam</a></h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                    ...
                                    <tbody>
                                        <?php 
                                            $select_stmt = $conn->prepare("SELECT * FROM timeslot_bbt"); //sql select query
                                            $select_stmt->execute();
