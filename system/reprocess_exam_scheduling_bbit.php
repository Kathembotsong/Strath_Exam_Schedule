...
if (isset($_POST['delete'])) {
    try {
        ...
        $deletedRowsMerged = $stmt->rowCount();
        ...
        // Check if any rows were affected
        $deletedRowsCollision = $stmt->rowCount();

        if ($deletedRowsMerged > 0 || $deletedRowsCollision > 0) {
            // Redirect to process_exam_scheduling_bbit.php
                ...
                <div class="panel panel-default">
                    <center>
                        <div class="panel-heading">
                            <h1 style="text-align: center;">REPROCESSING BBT EXAM SCHEDULE?</h1>
                        </div>
