...
if(isset($_REQUEST['delete_id'])){
    ...
    $delete_stmt->execute();
    header("Location: read_draft_exam_schedule_sls.php");
}
?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h3><a href="create_timeslot_sls.php" style="text-decoration:none;"><span class="fas fa-plus"></span>&nbsp; New Exam</a></h3>
                        </div>
