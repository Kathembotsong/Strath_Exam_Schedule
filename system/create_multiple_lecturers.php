...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $numUsers = count($_POST['lecturer_code']);

    for ($i = 0; $i < $numUsers; $i++) {
        $code = htmlspecialchars($_POST['lecturer_code'][$i]);
        $name = htmlspecialchars($_POST['lecturer_name'][$i]);         
        $email = htmlspecialchars($_POST['lecturer_email'][$i]);
...
?>
    ...
    <div class="container mt-5">
        <h2 class="mb-4">Enrol Multiple Lecturers at the same time</h2>
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="row row-cols-1 row-cols-md-5 g-4">
                ...
                for ($i = 0; $i < $numUsers; $i++) {
                    ...
                    echo "<h3 class='card-title text-center mb-4'>Lecturer " . ($i + 1) . "</h3>";
                    echo "<label for='lecturer_code[$i]' class='form-label'>Lecturer Code:</label>";
                    echo "<input type='text' name='lecturer_code[]' class='form-control' ><br>";

                    echo "<label for='lecturer_name[$i]' class='form-label'>Lecturer Name:</label>";
                    echo "<input type='text' name='lecturer_name[]' class='form-control' ><br>";

                    echo "<label for='lecturer_email[$i]' class='form-label'>Lecturer Email:</label>";
                    echo "<input type='email' name='lecturer_email[]' class='form-control' ><br>";

                    echo "<label for='lecturer_phone[$i]' class='form-label'>Lecturer Phone:</label>";
                    echo "<input type='text' name='lecturer_phone[]' class='form-control' ><br>";

                    echo "<label for='lecturer_school[$i]' class='form-label'>Lecturer School:</label>";
                    echo "<input type='text' name='lecturer_school[]' class='form-control' ><br>";
