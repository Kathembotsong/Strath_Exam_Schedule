...
if (isset($_GET['update_id'])) {
    ...
    $select_stmt = $conn->prepare('SELECT * FROM subjects_bbt WHERE subject_code = :id');
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $update_stmt = $conn->prepare('UPDATE subjects_bbt SET subject_code = :subject_code, subject_name = :subject_name WHERE subject_code = :id');
        ...
        if ($update_stmt->execute()) {
            header('Location: read_subjects_bbit.php'); // Redirect after successful update
            exit();
        } else {
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="post" action="">
                                ...
                                <a href="read_subjects_bbit.php" style="text-decoration:none;"><span class="fas fa-times btn btn-danger"></span></a>
                            </form>
                        </div>
                    </div>
                </div>
