...
if (isset($_POST['delete'])) {
    try {
        ...
        $deleteQuery = "DELETE FROM merged_data where timeslot_group_name like '%TOURISM%'";
        ...
        // Prepare the delete query
        $deleteCollision = "DELETE FROM exams_collision where timeslot_group_name like '%TOURISM%'";
        ...
        if ($stmt->rowCount() > 0) {
            header("Location:process_exam_scheduling_tourism.php");
        } else {
