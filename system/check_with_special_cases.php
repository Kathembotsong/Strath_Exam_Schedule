                ...
                <div class="panel panel-default">
                    <center>
                        ...
                        <div class="panel-body">
                            <form method="post">
                                <label for="student_code">Enter a retake Student Code:</label>
                                <div>
                                    <input type="text" name="student_code" style="background-color:white;" id="student_code">
                                </div>
                                <div>
                                    <input type="submit" name="check_timetable" class="btn btn-primary" value="Check Special Cases">
                                </div>
