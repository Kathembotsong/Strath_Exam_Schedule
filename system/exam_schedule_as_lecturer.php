            ...
            <div class="container" style="margin-left: 10%; width: 80%;">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #007bff; color: white; border-radius:5%;">
                        <h1 class="text-center" style="margin-top: 20px;">MY EXAM TIMETABLE AS LECTURER</h1>
                    </div>
                    <div class="panel-body" style="padding: 20px;">
                        ...
                        if (isset($_POST['check_timetable']) && isset($_POST['lecturer_name'])) {
                            ...
                            function getLecturerTimetable($conn, $lecturer_name) {
                                // Prepare the SQL query to retrieve exams associated with the lecturer_name
                                ...
                                if (count($timetable) > 0) {
                                    echo "<h2 style='color:red;'>Exam Timetable for lecturer_name: $lecturer_name</h2>";
                                    echo "<table border='1'>";
                                    echo "<tr>
                                            <th>Exam Day</th>
                                            <th>Exam Date</th>
                                    ...
                                    echo '<form method="post" action="individual_schedule_lecturer_pdf.php">
                                            ...
                                            <a href="exam_schedule_as_lecturer.php" style="text-decoration:none; margin-left: 10px;" class="btn btn-danger">
                                              <span class="fas fa-times"></span>
                                            </a>
                                          </form>';
                                } else {
                                    echo "No exams found for the lecturer: $lecturer_name";
                                }
                            }
                            ...
                            <form method="post">
                                <div class="form-group">
                                    <label for="lecturer_name">Enter Lecturer Name:</label>
