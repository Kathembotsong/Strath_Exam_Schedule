    ...
    if (isset($_POST['submit'])) {
        try {
            ...
            foreach ($student_codes as $student_code) {
                ...
                $checkStudentQuery = "SELECT COUNT(*) FROM students WHERE student_code = :student_code AND student_school = 'SCS'";
                ...
                if ($stmt->fetchColumn() > 0) {
                    foreach ($subjects as $subject) {
                        ...
                        $subjectNameQuery = "SELECT subject_name FROM subjects_scs WHERE subject_code = :subject_code";
                        ...
                        $sql = "INSERT INTO enrollments_scs (student_code, subject_code, subject_name, group_name, lect_name, enrol_status) VALUES (:student_code, :subject_code, :subject_name, :group_name, :lect_name, :status)";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h1 style="text-align: center;">SUBJECTS ENROLLMENTS SCS</h1>
                        </div>
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <?php
                                        try {
                                            $sql = "SELECT subject_code, subject_name FROM subjects_scs";
                                            $stmt = $conn->prepare($sql);
                                            $stmt->execute();
                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                $lecturerQuery = "SELECT lecturer_name FROM lecturers where lecturer_school= 'SCS'";
                                        ...
                                        <select class="form-control" name="group" id="group">
                                            <?php
                                            try {
                                                $sql = "SELECT group_name FROM group_scs";
                                                $stmt = $conn->prepare($sql);
                                                $stmt->execute();
                                 ...
                                 <a class="btn btn-danger fas fa-multiply" href="enrollment_multiple_scs.php"></a>
                            </form>
                        </div>
                    </div>
                </div>
