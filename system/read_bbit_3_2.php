...
if(isset($_REQUEST['delete_id'])){
    ...
    $delete_stmt->execute();
    header("Location:read_bbit_3_2.php");
}
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h1 style="text-align: center;">BBIT 3.2</h1>
                            <h3><a href="enrollment_bbt.php" style="text-decoration:none;"><span class="fas fa-plus"></span>&nbsp; Single Student to one group</a></h3>
