...
if(isset($_REQUEST['delete_id'])){
    ...
    $delete_stmt->execute();
    header("Location:read_conflicts_bbit.php");
}
?>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h1 style="text-align: center;">EXAMS COLLISION IN BBIT</h1>
                </div>
                <div class="panel-body">
                    <div class="table-responsive">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
                                <?php 
                                    $select_stmt = $conn->prepare("SELECT * FROM exams_collision where timeslot_group_name like '%BBT%'"); //sql select query
                                    $select_stmt->execute();
