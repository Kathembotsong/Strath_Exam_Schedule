...
if(isset($_POST['update'])){
    ...
    if(empty($student_code) || empty($subject_code) || empty($subject_name) || empty($group_name) || empty($lect_name) || empty($enrol_status)){
        ...
        try {
            $update_stmt = $conn->prepare('UPDATE enrollments_sls SET student_code=:student_code, subject_code=:subject_code, subject_name=:subject_name, group_name=:group_name, lect_name=:lect_name, enrol_status=:enrol_status WHERE enrol_id=:id');
            ...
            if($update_stmt->execute()){
                ...
                header("refresh:2;read_sls_1_1.php"); // redirect to read_bcom_1_1.php after 2 seconds
            }
                            ...
                            <div class="panel-body">
                                ...
                                <form method="post" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-danger fas fa-multiply" href="read_sls_1_1.php"></a>
                                    </div>
                                </form>
                            </div>
                        </div>
