            ...
            <?php
               ...
               function registerUser($code, $name, $email, $phone, $school, $password) {
                  ...
                  try {
                      ...
                      $stmt = $conn->prepare("INSERT INTO admins (admin_code, admin_name, admin_email, admin_phone, admin_school, admin_password) VALUES (?, ?, ?, ?, ?, ?)");
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $code = htmlspecialchars($_POST['admin_code']);
