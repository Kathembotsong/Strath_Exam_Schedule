...
if (isset($_POST['delete'])) {
    try {
        ...
        $deleteQuery = "DELETE FROM merged_data WHERE timeslot_group_name LIKE '%SLS%'";
        ...
        $deleteCollision = "DELETE FROM exams_collision WHERE timeslot_group_name LIKE '%SLS%'";
        ...
        if ($stmt->rowCount() > 0) {
            header("location:process_exam_scheduling_sls.php");
        } else {
                ...
                <div class="panel panel-default">
                    <center>
                        <div class="panel-heading">
                            <h1 style="text-align: center;">REPROCESSING SLS EXAM SCHEDULE?</h1>
                        </div>
