...
$venueStmt = $conn->query("SELECT * FROM group_scs");
...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $conn->prepare('DELETE FROM group_scs WHERE group_id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();
	header("Location:read_group_scs.php");
}
?>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><a href="edit_group_scs.php?update_id=<?php echo $row['group_id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
