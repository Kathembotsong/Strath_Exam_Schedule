		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                <div class="panel-heading">
                    <h1 style="text-align: center;">TOURISM STUDENTS</h1>
					<h3><a href="create_single_student_sls.php" style="text-decoration:none;"><span class="fas fa-plus"></span>&nbsp; Single New Student</a></h3>
                    <h3><a href="create_multiple_students_sls.php" style="text-decoration:none;"><span class="fas fa-plus"></span>&nbsp; Multiple New Students</a></h3>
                ...
                <div class="panel-body">
                	<div class="table-responsive">
						<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
							...
							<tbody>
								<?php 
                                    $select_stmt = $conn->prepare("SELECT * FROM students where student_school='TOURISM'"); //sql select query
                                    $select_stmt->execute();
							    ...
							    <tr>
									...
									<td><a href="edit_students_tourism.php?update_id=<?php echo $row['student_id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
